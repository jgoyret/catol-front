...
`,
    description: `
Synonymous with homage, an <enhanced style="cutietitle">ODE</enhanced> is a poem traditionally accompanied by music, dedicated to a person or event. Here, <enhanced style="cutietitle">ODE</enhanced> unfolds as a dance dedicated to gaps, to ruptures and to transformations. Catol Teixeira’s choreographic research takes the form of a homage to that which does not occur, to that which never really settles in. <enhanced style="cutietitle">ODE</enhanced> thus becomes a practice session devoted to the unaccomplished.

I  It carries the ache of departures, the friction of what resists, the pulse of something unknown. The body, caught between what was and what will be, absorbs the after-effect—a tremor in the hands, a tightness in the chest, a hesitation in the step. Some traces linger like stains, stubborn and unrelenting, carried even when they are not seen. Others, with time, reveal themselves as grace—subtle, fleeting, a lightness that comes only in the wake of surrender.
...
The dance unfolds as an act of transition: what was once a moment of uncertainty, a break in rhythm, now manifests as movement. A stumble becomes a turn. A contraction unfurls into fluidity. The body carries the past forward, but not passively—it reshapes it, negotiates with it, turns weight into momentum.
    ...
    poems: {
      head: ``,
      end: `<enhanced style="cutietitle">ODE</enhanced> searches to inhabit the raw space where traces linger, where steps are haunted by what came before, and yet, still pushes toward the unknown. The residue of a movement, the echo of a choice, the afterimage of impact. In the tension between stain and grace, the dance unfolds—not to answer, but to move in relation to.`,
    },
    media: {
      head: "https://player.vimeo.com/video/1095654012",
      single: `${import.meta.env.VITE_SUPABASE_STORAGE_URL}/ODE3.webp`,
      dual: [
        `${import.meta.env.VITE_SUPABASE_STORAGE_URL}/ODE2.webp`,
        `${import.meta.env.VITE_SUPABASE_STORAGE_URL}/ODE5.webp`,
      ],
    },
    usePoemImageLayout: false,
    navigationBanner: false,
...
Catol Teixeira is a dancer and choreographer living and working between Rio de Janeiro and Geneva. Born in Porto Alegre and based in Rio since adolescence, Catol trained in ballet, circus, and different contemporary dance approaches.

Catol’s choreographic experimentations function as channels for revealing nuances and tactics of coexistence and relation. Their interests center on collaborative processes that bring together artistic practices and collective inquiries, generating an intimate dialogue with trans-(dis)orientations: recalling dreams and enacting an obstinate gesture to undo imposed narratives of modernity-coloniality.

Catol began working as a dancer interpreter with companies in Belo Horizonte, including Palácio das Artes, SESC MG, and Mário Nascimento, between 2013 and 2015, and with the circus group Intrépida Trupe in Rio de Janeiro from 2010 to 2016. In 2016, Catol began working and studying outside Brazil, first at SEAD–Bodhi Project in Salzburg and later with ROAR in Berlin. In 2021, Catol completed a BA in Contemporary Dance at La Manufacture – Haute École des Arts de la Scène in Lausanne, and further studied in the Fine Arts Master’s programme at HEAD – Genève.

Since then, Catol studies choreographic and performance practices and shared his work at venues and festivals including Pavillon ADC (Geneva), Théâtre Vidy (Lausanne), La Ménagerie de Verre (Paris), Points Communs (Cergy), Festival Rakete – Tanzquartier (Vienna), Festival Actoral (Marseille), Festival Santarcangelo, Sélection Suisse at Festival d’Avignon, Gessnerallee (Zurich), KINANI Bienal (Maputo), MACRO (Rome), Bienal de Dança SESC (Campinas), 8:tension/ImPulsTanz Festival (Vienna), among others.

Catol’s first group choreographic direction, “arrebentação”, premiered at Pavillon ADC in November 2024; their solo “ODE” was premiered at Théâtre Vidy Lausanne in May 2025; and in 2026, Catol is creating “BABY TEETH” in collaboration with a group of 15 artists and friends.
`;
