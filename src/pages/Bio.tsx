...
const Bio: React.FC = () => {
  return (
    <>
      ...
      <div className="absolute top-5 left-0 m-10 md:m-40 lg:m-52 2xl:m-80 3xl:m-96 text-md md:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl text-center text-white">
        <EnhancedText>{biotext}</EnhancedText>
